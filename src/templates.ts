...
export const TEMPLATES: Template[] = [
  {
    ...
    values: {
      docType: '提案書（PowerPoint）',
      purpose: '経営層に新施策の必要性を理解してもらい、実施承認を得る',
      audience: '経営層・役員',
      presenter: '事業部長が説明、役員数名が同席',
      scene: '役員会、四半期経営会議',
      language: '日本語（敬体）',
      ...
      decisionMaker: '取締役会の合議で決定',
      cost: '初期費用と年間運用費の概算、ROIの目安',
      comparison: '今回提案・他案・現状維持の3案比較',
  ...
  },
  {
    ...
    values: {
      docType: '研修資料（PDF配布／eラーニング）',
      purpose: '対象者に知識を習得してもらい、業務で実践できる状態にする',
      audience: '全社員（部門・役職を問わず）',
      presenter: '人事担当が講師、または各部門の管理職が読み合わせ',
  ...
  },
  {
    ...
    values: {
      ...
      comparison: '導入企業の事例、他社サービスとの違い',
      cost: '初期費用、月額／年額、想定ROI',
